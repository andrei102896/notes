...
export function isContentToPanelMessage(
  value: unknown,
  ...
  const t = m.type;
  if (t === "nn_cp/page_context") {
    return (
      typeof m.payload === "object" &&
      m.payload !== null &&
      typeof (m.payload as Record<string, unknown>).url === "string" &&
      typeof (m.payload as Record<string, unknown>).scrollX === "number" &&
      typeof (m.payload as Record<string, unknown>).scrollY === "number"
    );
  }
  if (t === "nn_cp/anchor_pick_result") {
    const p = m.payload as Record<string, unknown> | null;
    return (
      typeof p === "object" &&
      p !== null &&
  ...
  if (t === "nn_cp/anchor_pick_cancelled") {
    return true;
  }
  if (t === "nn_cp/error") {
    return typeof m.code === "string" && typeof m.message === "string";
  }
  if (t === "nn_cp/anchor_scroll_result") {
    return typeof m.elementFound === "boolean";
  }
  return false;
}
